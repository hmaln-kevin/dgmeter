...
class MeasuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post measures_url, params: { measure: { current: @measure.current, date: @measure.date, energy: @measure.energy, frequency: @measure.frequency, pf: @measure.pf, power: @measure.power, voltage: @measure.voltage } }
    end
  ...
  test "should update measure" do
    patch measure_url(@measure), params: { measure: { current: @measure.current, date: @measure.date, energy: @measure.energy, frequency: @measure.frequency, pf: @measure.pf, power: @measure.power, voltage: @measure.voltage } }
